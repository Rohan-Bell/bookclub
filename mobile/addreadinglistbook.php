...
$initialquery = "SELECT * FROM readinglist WHERE bookid = %s AND userid = %s";
$result = DB::query($initialquery,$bookid,$userid);
...
if ($result){
    ...
    $addquery = "INSERT INTO readinglist (bookid, userid) 
    VALUES (%s, %s)";
    $result = DB::query($addquery,$bookid,$userid);
