...
$initialquery = "SELECT clubid FROM clubmembership WHERE userid = %s AND status = 'approved' AND role = 'member'";
...
if ($result) {
    ...
    $response = array("success" => false, "message" => "User is not a member in any book clubs");
